...
function Loader(scene) {
		...
		switch ( extension ) {
			...
			case '3dm':
				...
				reader.addEventListener( 'load', async function ( event ) {
					...
					var { Rhino3dmLoader } = await import( './loaders/3DMLoader.js' );
			...
			case '3ds':
				...
				reader.addEventListener( 'load', async function ( event ) {
					...
					var { TDSLoader } = await import( './loaders/TDSLoader.js' );
			...
			case 'amf':
				...
				reader.addEventListener( 'load', async function ( event ) {
					...
					var { AMFLoader } = await import( './loaders/AMFLoader.js' );
			...
			case 'dae':
				...
				reader.addEventListener( 'load', async function ( event ) {
					...
					var { ColladaLoader } = await import( './loaders/ColladaLoader.js' );
			...
			case 'drc':
				...
				reader.addEventListener( 'load', async function ( event ) {
					...
					var { DRACOLoader } = await import( './loaders/DRACOLoader.js' );
			...
			case 'fbx':
				...
				reader.addEventListener( 'load', async function ( event ) {
					...
					var { FBXLoader } = await import( './loaders/FBXLoader.js' );
			...
			case 'glb':
				...
				reader.addEventListener( 'load', async function ( event ) {
					...
					var { DRACOLoader } = await import( './loaders/DRACOLoader.js' );
					var { GLTFLoader } = await import( './loaders/GLTFLoader.js' );
			...
			case 'ifc':
				...
				reader.addEventListener( 'load', async function ( event ) {
					...
					var { IFCLoader } = await import( './loaders/IFCLoader.js' );

					var loader = new IFCLoader();
					var loadedScene = await loader.parse( event.target.result );
			...
			case 'kmz':
				...
				reader.addEventListener( 'load', async function ( event ) {
					...
					var { KMZLoader } = await import( './loaders/KMZLoader.js' );
			...
			case 'md2':
				...
				reader.addEventListener( 'load', async function ( event ) {
					...
					var { MD2Loader } = await import( './loaders/MD2Loader.js' );
			...
			case 'ply':
				...
				reader.addEventListener( 'load', async function ( event ) {
					...
					var { PLYLoader } = await import( './loaders/PLYLoader.js' );
			...
			case 'svg':
				...
				reader.addEventListener( 'load', async function ( event ) {
					...
					var { SVGLoader } = await import( './loaders/SVGLoader.js' );
			...
			case 'vox':
				...
				reader.addEventListener( 'load', async function ( event ) {
					...
					var { VOXLoader, VOXMesh } = await import( './loaders/VOXLoader.js' );
			...
			case 'vtk':
				...
				reader.addEventListener( 'load', async function ( event ) {
					...
					var { VTKLoader } = await import( './loaders/VTKLoader.js' );
			...
			case 'wrl':
				...
				reader.addEventListener( 'load', async function ( event ) {
					...
					var { VRMLLoader } = await import( './loaders/VRMLLoader.js' );
			...
			case 'xyz':
				...
				reader.addEventListener( 'load', async function ( event ) {
					...
					var { XYZLoader } = await import( './loaders/XYZLoader.js' );
	...
	async function handleZIP( contents ) {
		...
		if ( zip[ 'model.obj' ] && zip[ 'materials.mtl' ] ) {
			...
			var { MTLLoader } = await import( './loaders/MTLLoader.js' );
			var { OBJLoader } = await import( './loaders/OBJLoader.js' );
